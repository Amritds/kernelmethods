...
np.save('KL_POLY_degree1',kD1)
np.save('KL_POLY_degree3',kD2)
np.save('KL_POLY_degree5',kD3)

np.save('ObsPolyprob_deg1',p1)
np.save('ObsPolyprob_deg3',p2)
np.save('ObsPolyprob_deg5',p3)
