...
from Utilities.kernels import norm_kernelLinear, kernelPoly, kernelRBF
...
kLin =lambda X1,X2: norm_kernelLinear(X1,X2) #Any setting is fine.
...
#----Save selections ---------------------------------------------#
with open('choicesNORM_LINKernel.pickle', 'wb') as f:
