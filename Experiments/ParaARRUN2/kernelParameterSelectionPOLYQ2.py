...
for thetaval in thetaVals[5:10]:
  #  print('++++++++++++++++++++++++++ ',thetaval,' ++++++++++++++++++++++++++++++++++++')
   ...
   # allChoices1.append(choices)
    ...
    print('++++++++++++++++++++++++++ ',thetaval,' ++++++++++++++++++++++++++++++++++++')
    (gamma,regScale, scores) = hC.autoGammaReal_and_RegScale(kF,clf2,model1,thetaval ,n_samples, numberOfOptions =20)
    choices = (gamma,regScale, scores)
   ...
   # print('++++++++++++++++++++++++++ ',thetaval,' ++++++++++++++++++++++++++++++++++++')
   # (gamma,regScale, scores) = hC.autoGammaReal_and_RegScale(kF,clf2,model2,thetaval ,n_samples, numberOfOptions =20)
   # choices = (gamma,regScale, scores)
