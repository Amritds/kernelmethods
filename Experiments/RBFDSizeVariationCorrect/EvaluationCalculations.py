...
p2 = np.hstack([p2,probabilities[1]])
p3 = np.hstack([p3,probabilities[2]])
pRBF = np.hstack([pRBF,probabilities[3]])
...
kD1 = model.klDivergence(muVals,obsData,p1)
kD2 = model.klDivergence(muVals,obsData,p2)
kD3 = model.klDivergence(muVals,obsData,p3)
kDRBF = model.klDivergence(muVals,obsData,pRBF)
np.save('KL_POLY_degree2',kD1)
np.save('KL_POLY_degree4',kD2)
np.save('KL_POLY_degree6',kD3)
np.save('KL_RBF',kDRBF)

np.save('ObsPolyprob_deg2',p1)
np.save('ObsPolyprob_deg4',p2)
np.save('ObsPolyprob_deg6',p3)
np.save('ObsPolyprob_RBF',pRBF)
